# @cassianotbnb/react-native-keyboard-sticky-footer-avoiding-scroll-view
...
`$ yarn add @cassianotbnb/react-native-keyboard-sticky-footer-avoiding-scroll-view`
...
```javascript
import {KeyboardAvoidingScrollView} from '@cassianotbnb/react-native-keyboard-sticky-footer-avoiding-scroll-view';
